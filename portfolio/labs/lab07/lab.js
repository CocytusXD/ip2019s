...
function analyze() {
    ...
    do {
      ...
      var path = image.path(subs).fill('black').stroke({color:'red',width:5}).draggable();
      ...
      for (var i = 0; i < (newPath.length - 1);i++){
      	...
      	if (i == 0){
      		...
      		var circle = image.circle(10).fill('pink').stroke('blue').move(newPath[i][3]-10, newPath[i][4]-10).draggable();
